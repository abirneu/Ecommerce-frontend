...
const ProductsData =[
    ...
    },
    {
        ...
        img:Img2,
        title: "Formal Attire", 
        description: "Elegant formal attire for special occasions and business events.",
    },
    {
        id:3, img:Img3,
        title: "Sportswear",
        description: "High-performance sportswear designed for active lifestyles.",
    }
]
    ...
    return (
        <div className=''>
            <div className='container'>
                ...
                sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-5 '>
                    {
                        ...
                        >  
                            ...
                            <div className='p-4 text-center'>
                                ...
                                duration-300  line-clamp-2'>{data.description}</p>
